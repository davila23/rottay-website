...
const positions = [
  {
    id: 'sr-ai-engineer',
    title: 'Senior Software Engineer - Voice AI',
    department: 'Engineering',
    location: 'Remote (Global)',
    type: 'Full-time',
    salary: 'Competitive based on experience',
    equity: 'Equity package available',
    level: 'Senior',
    description: 'Build and optimize voice AI systems for enterprise clients. Work on real-time speech processing, natural language understanding, and integration with cloud telephony infrastructure.',
    requirements: [
  ...
  },
  {
    ...
    equity: 'Equity package available',
    level: 'Senior',
    description: 'Help us build a world-class engineering team. Focus on sourcing and hiring senior engineers with expertise in voice AI, cloud infrastructure, and enterprise software development.',
    requirements: [
